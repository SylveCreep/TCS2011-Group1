...
public class ResponseUtils {
    ...
    public ResponseEntity<?> getResponseEntity(Object data, int code, String mess, Object total, Object validate,
            HttpStatus status) {
        Map<String, Object> response = new HashMap<>();
        response.put("data", data);
        response.put("code", code);
    ...
    public ResponseEntity<?> getActionResponseEntity(Object data, int code, String mess, Object validate,
            HttpStatus status) {
        Map<String, Object> response = new HashMap<>();
        response.put("data", data);
        response.put("code", code);
    ...
    public HashMap<String, Object> validateCreateAccountRequest(CreateAccount createAccount, MultipartFile file,
            int type) {
    ...
    public String validateBirthDayInput(Date dateOfBirth) {
        ...
        if ((Integer.parseInt(dateFormat.format(currentDate).substring(0, 4))
                - Integer.parseInt(dateFormat.format(dateOfBirth).substring(0, 4))) > 18) {
            return "Valid";
        } else {
    ...
    public HashMap<String, Object> validateRoleRequest(CreateRole createRole, int type) {
        ...
        // String valUpdateNameRole = validateNameRoleUpdateInput(createRole.getName(),
        // createRole.getId());
        // String valUpdateCodeRole = validateCodeRoleUpdateInput(createRole.getCode(),
        // createRole.getId());
    ...
    public HashMap<String, Object> validateContributionRequest(ContributionRequest contributionRequest,
    ...
    public String validateContributionFile(MultipartFile file) {
        ...
        if (!file.getContentType().startsWith("image/") && !allowExtensionList.contains(extension)) {
            return "Only accept pdf file and image file";
        }
        return "Valid";
    }
    ...
    public HashMap<String, Object> validateMagazineRequest(CreateMagazine createMagazine, int type) {
        ...
        case 0:
            ...
            /*
             * if (!valOpenAt.equals("Valid")){ inputForm.put("name", valOpenAt); if
        ...
        case 1:
            ...
            /*
             * if (!valCode.equals("Valid")){ inputForm.put("code", valCode); if
             * (!form.containsKey("result")){ form.put("result", -1); } }
             */
            if (!valId.equals("Valid")) {
                inputForm.put("id", valId);
    ...
    /*
     * public String validateOpenAtMagazineInput(Date openAt){ if(openAt == null){
